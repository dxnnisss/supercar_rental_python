...
class StartMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button2 = ttk.Button(self, text="View Cars", command=self.view_car())
...
class LoginRegister(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        label = ttk.Label(self, text="Login/Register", font=largefont)
...
class Login(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = ttk.Button(self, text="Login as Member", command=lambda: controller.show_frame(login()))
        button1.grid(row=1, column=1, padx=10, pady=10)

        button2 = ttk.Button(self, text="Login as Admin", command=lambda: controller.show_frame(admin_login()))
