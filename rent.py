...
def rent_car():
    ...
    while True:
            ...
            while car_name in file:
                ...
                for userfile in open("memberdetails.txt"):
                    ...
                    if user_name in userfile[1] and user in userfile[2]:
                        ...
                        with open("rentedCar.txt") as rent_details:
                            rent_details = rent_details.readlines()
                            for detail_line in rent_details:
                                detail_line = detail_line.strip("\n").split("|")
                                start_rent = detail_line[3]
                                end_rent = detail_line[4]
        ...
        #                     if car_name in file and existing_rent <= check_start <= existing_return or existing_rent <= check_end <= existing_return:
        #
